...
export default function PolicyKo() {
  return (
    <>
        ...
        <div className="prose prose-sm max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <ol className="ml-6 list-decimal space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  본 서비스는 계정 중복 가입 여부 확인, 환영 이메일 발송 및
                  비밀번호 재설정을 위해 이메일 정보를 수집합니다. 이메일
                  오기입으로 인한 계정 분실의 책임은 사용자에게 있습니다.
                </li>
                <li>
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  <strong>필수 항목</strong>: 아이디(userid), 비밀번호,
                  이름(닉네임), 이메일 주소
                </li>
                <li>
            ...
            <div className="mb-6">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>회원 가입 시 이메일 중복 가입 여부 확인</li>
                <li>회원 가입 완료 시 환영 메일 발송</li>
